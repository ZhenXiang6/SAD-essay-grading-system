...
建議至我們的github網址: https://github.com/ZhenXiang6/SAD-essay-grading-system 觀看 README 以獲取良好的閱讀體驗。
...
請參照資**其餘文件**料夾中的 **User_Stories_Mapping.png**

## Low-fidelity wireframes

經過使用者訪談後，我們對 MVP　的介面和功能進行迭代，設計了全新wireframe，請參照**其餘文件**資料夾中的 **figma_design.png**
...
為驗證系統功能正確性，本專案特別請我們的組員，**萬里雲 QA 實習生陳奕廷** 負責測試的部分，撰寫的測試報告請參照測試報告請參照**其餘文件**資料夾中的 **SAD測試報告.pdf**
